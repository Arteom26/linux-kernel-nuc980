...
static const struct nuc980_clk_gate_data nuc980_gates[] __initconst = {
	...
	{ CLK_PCLKEN0, 16, NUC980_CLK_S_UART_CLK(0), NUC980_CLK_S_UART_DIV(0), 0, 0, NUC980_CLK_UART0 },// UART Clock Gates
	...
	{ CLK_PCLKEN0, 8, NUC980_CLK_S_TIM_CLK(0), NUC980_CLK_S_TIM_MUX(0), 0, 0, NUC980_CLK_TIM0 },// Timer Clock Gates
	{ CLK_PCLKEN0, 9, NUC980_CLK_S_TIM_CLK(1), NUC980_CLK_S_TIM_MUX(1), 0, 0, NUC980_CLK_TIM1 },
	{ CLK_PCLKEN0, 10, NUC980_CLK_S_TIM_CLK(2), NUC980_CLK_S_TIM_MUX(2), 0, 0, NUC980_CLK_TIM2 },
	...
	{ CLK_HCLKEN, 30, NUC980_CLK_S_SDH_CLK, NUC980_CLK_S_SDH_DIV, 0, 0, NUC980_CLK_SDH },// SD Card clock gate
	{ CLK_HCLKEN, 12, NUC980_CLK_S_PDMA0_CLK, NUC980_CLK_S_HCLK1, 0, 0, NUC980_CLK_PDMA0 },// PDMA Clock Gates
